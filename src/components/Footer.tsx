        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-8 max-w-md font-light leading-relaxed">
              Timeless Design. Modern Living. We specialize in creating premium
              homes that blend sophisticated architecture with contemporary
              comfort.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  to="/"
                  className="text-gray-400 hover:text-luxury-gold transition-colors duration-300 font-light"
                >
                  Home
                </Link>
              </li>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-2">
                ...
                <span className="text-gray-400 font-light">
                  847 Wake Forest Business Park Ste 102
                  <br />
